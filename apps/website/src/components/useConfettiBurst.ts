...
// transitions.dev Pro "confetti-burst" — React hook, adapted to
// TypeScript with the brand palette instead of the rainbow default.
// Physics confetti over a stage element, with the trigger button as a
// collision body (true pill model). Skips under reduced motion; the
// stage/canvas styles and --confetti-* tokens live in
